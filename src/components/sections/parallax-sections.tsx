  ...
  return (
    <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-4 pb-24 pt-12 md:grid-cols-12 md:px-8">
      ...
      <div className="col-span-1 md:col-span-8">
        ...
        <a
          href="/devis"
          className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-teal-600 px-9 py-4 text-xl font-medium text-white transition-colors hover:bg-teal-700 md:w-fit"
        >
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3">
                  ...
                  <span className="rounded-full bg-teal-600 px-3 py-0.5 text-xs font-medium text-white">
                    {step.time}
                  </span>
                </div>
    ...
    <div className="mx-auto max-w-5xl px-4 pb-24 pt-12 md:px-8">
      <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
        <div className="col-span-1 md:col-span-4">
          ...
          <a
            href="/devis"
            className="mt-8 inline-flex items-center gap-2 rounded-lg bg-teal-600 px-8 py-4 text-lg font-medium text-white transition-colors hover:bg-teal-700"
          >
            Devis gratuit
            <ArrowUpRight className="h-5 w-5" />
          </a>
