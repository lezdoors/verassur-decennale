  ...
  return (
    <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-4 pb-24 pt-12 md:grid-cols-12 md:px-8">
      ...
      <div className="col-span-1 md:col-span-8">
        ...
        <a
          href="/devis"
          className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-gold px-9 py-4 text-xl font-medium text-navy transition-colors hover:bg-gold-light md:w-fit"
        >
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
        ...
        <div className="col-span-1 space-y-6 md:col-span-8">
          {steps.map((step) => (
            ...
            >
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-navy-light text-gold">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3">
                  ...
                  <span className="rounded-full bg-gold px-3 py-0.5 text-xs font-medium text-navy">
                    {step.time}
                  </span>
                </div>
    ...
    <div className="mx-auto max-w-5xl px-4 pb-24 pt-12 md:px-8">
      <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
        <div className="col-span-1 md:col-span-4">
          ...
          <a
            href="/devis"
            className="mt-8 inline-flex items-center gap-2 rounded-lg bg-gold px-8 py-4 text-lg font-medium text-navy transition-colors hover:bg-gold-light"
          >
            Devis gratuit
            <ArrowUpRight className="h-5 w-5" />
          </a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="mt-0.5 flex items-center gap-2">
                    ...
                    <span className="rounded-full bg-gold px-2 py-0.5 text-[10px] font-medium text-navy">
                      Obligatoire
                    </span>
                  </div>
                </div>
