...
export const GRADIENT_COLORS = {
  ...
  verassur: [
    { color: "#2D6A4F", start: "0%" },
    { color: "#1B4332", start: "22.92%" },
    { color: "#143728", start: "42.71%" },
    { color: "#081C15", start: "88.54%" },
  ],
  skyblue: [
...
const TRANSITION_CONFIG = { ease: [0.25, 0.1, 0.25, 1] as [number, number, number, number], duration: 0.5 }
