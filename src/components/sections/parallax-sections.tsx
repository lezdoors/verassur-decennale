  ...
  return (
    <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-4 pb-24 pt-12 md:grid-cols-12 md:px-8">
      ...
      <div className="col-span-1 md:col-span-8">
        ...
        <a
          href="/devis"
          className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-violet-600 px-9 py-4 text-xl font-medium text-white transition-colors hover:bg-violet-700 md:w-fit"
        >
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
        ...
        <div className="col-span-1 space-y-6 md:col-span-8">
          {steps.map((step) => (
            ...
            >
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-violet-600 text-white">
          ...
          <a
            href="/devis"
            className="inline-flex items-center gap-2 rounded-lg bg-violet-600 px-8 py-4 text-lg font-medium text-white transition-colors hover:bg-violet-700"
          >
            Obtenir mon devis gratuit
            <ArrowUpRight className="h-5 w-5" />
          </a>
    ...
    <div className="mx-auto max-w-5xl px-4 pb-24 pt-12 md:px-8">
      <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
        <div className="col-span-1 md:col-span-4">
          ...
          <a
            href="/devis"
            className="mt-8 inline-flex items-center gap-2 rounded-lg bg-violet-600 px-8 py-4 text-lg font-medium text-white transition-colors hover:bg-violet-700"
          >
            Devis gratuit
            <ArrowUpRight className="h-5 w-5" />
          </a>
