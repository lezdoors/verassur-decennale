...
function FAQItem({
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-base font-medium text-neutral-900 group-hover:text-blue-600 transition-colors">
          {faq.q}
        </span>
        <motion.div
  ...
  return (
    <section id="faq" className="bg-white py-20 sm:py-28">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        >
          <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-1.5">
        ...
        >
          ...
          <div className="mt-5 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <a
              href="/devis"
              className="inline-flex items-center rounded-lg bg-blue-600 px-6 py-2.5 text-sm font-medium text-white transition-all hover:bg-blue-700"
            >
              Demander un devis
            </a>
            <a
